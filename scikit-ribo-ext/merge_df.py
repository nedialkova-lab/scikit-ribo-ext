...
class MergeDF(object):
    ...
    def __init__(self, fn=None, tpmFn=None, output=None):
        self.fn = fn
        # Modified to remove the RNAfold dependencies
    ...
    def mergeDf(self):
        ...
        ## Modified to remove the RNAfold dependencies
        codons = codons[["chrom", "start", "end", "gene", "codon_idx", "gene_strand", "codon", "TPM"]]
...
if __name__ == '__main__':
    ...
    if (args.f != None) & (args.t != None) & (args.o != None):
